...
const navItems = [
  ...
  { title: 'Warehouses', url: '/factory/warehouse/manage' },
  { title: 'Storage Zones', url: '/factory/warehouse/storage' },
  { title: 'Production', url: '/factory/warehouse/production' },
  { title: 'Drivers', url: '/factory/drivers' },
  { title: 'Route Planning', url: '/factory/dispatch/routes' },
